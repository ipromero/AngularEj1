...
<html lang="en">
  <head>
    ...
    <title>Dashboard for a grocery</title>

    <!-- Bootstrap core CSS
    <link hre f="../../dist/css/bootstrap.min.css" rel="styleshe et">
     -->
    ...
    <link href="/resources/core/css/ rel="stylesheet">
     -->
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            ...
            <li><a href="consulta">Consulta Producto</a></li>
